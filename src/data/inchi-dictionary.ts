...
export const INCHIDictionary: Record<string, INCHIProps> = {
  ...
  BasicAluminumAcetate: {
    CAS: "142-03-0",
    inchiString: "InChI=1S/2C2H4O2.Al.H2O/c2*1-2(3)4;;/h2*1H3,(H,3,4);;1H2/q;;+2;/p-2",
  ...
  DialuminumHeptafluoride: {
    CAS: "",
    inchiString: "",
    inchiKey: "",
    molecularWeight: 294.06
  },
  ...
  AluminumNitrateNonahydrate: {
    CAS: "7784-27-2",
    inchiString: "InChI=1S/Al.3NO3.9H2O/c;3*2-1(3)4;;;;;;;;;/h;;;;9*1H2/q+3;3*-1;;;;;;;;;",
    inchiKey: "SWCIQHXIXUMHKA-UHFFFAOYSA-N",
    molecularWeight: 375.13
  },
  ...
  AluminumPhosphate: {
    ...
    molecularWeight: 121.95
  },

  AluminumPotassiumSilicateMuscovite: {
    CAS: "",
    inchiString: "",
    inchiKey: "",
    molecularWeight: 796.61
  },

  AluminumPotassiumSilicateOrthoclase: {
    CAS: "",
    inchiString: "",
    inchiKey: "",
  ...
  AluminumSulfate: {
    CAS: "10043-01-3",
    inchiString: "InChI=1S/2Al.3H2O4S/c;;3*1-5(2,3)4/h;;3*(H2,1,2,3,4)/q2*+3;;;/p-6",
  ...
  AmmoniumCarbonateCarbamate: {
    CAS: "8000-73-5",
    inchiString: "InChI=1S/CH3NO2.CH2O3.2H3N/c2*2-1(3)4;;/h2H2,(H,3,4);(H2,2,3,4);2*1H3",
  ...
  AmmoniumOxalate: {
    CAS: "6009-70-7",
    inchiString: "InChI=1S/C2H2O4.2H3N.H2O/c3-1(4)2(5)6;;;/h(H,3,4)(H,5,6);2*1H3;1H2",
  ...
  AmmoniumOxalateAcid: {
    CAS: "5972-73-6",
    inchiString: "InChI=1S/C2H2O4.H3N.H2O/c3-1(4)2(5)6;;/h(H,3,4)(H,5,6);1H3;1H2",
  ...
  AmmoniumPersulfate: {
    CAS: "7727-54-0",
    inchiString: "InChI=1S/2H3N.H2O8S2/c;;1-9(2,3)7-8-10(4,5)6/h2*1H3;(H,1,2,3)(H,4,5,6)",
  ...
  AmmoniumTartrate: {
    CAS: "3164-29-2",
    inchiString: "InChI=1S/C4H6O6.2H3N/c5-1(3(7)8)2(6)4(9)10;;/h1-2,5-6H,(H,7,8)(H,9,10);2*1H3",
