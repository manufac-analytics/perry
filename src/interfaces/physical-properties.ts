import { Qualitative, Measure, MeasureRange, MeltingOutcome, SolubilitySheet, SpecificGravity } from "./utils";
...
export interface PhysicalProperties {
  ...
  crystallineForms?: Qualitative<CrystallineForms>[] | Qualitative<CrystallineForms>;
