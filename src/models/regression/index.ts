...
/*var optionsToBeUsed(hyperPerameterCombinations) => {
  for (var i = 0; i < hyperPerameterCombinations.length; i++) {
    var optionsToBeTaken = hyperPerameterCombinations[i];
    return optionsToBeTaken;
  }
}*/
...
const RFRModel = new RandomForestClassifier(options);
let startTime = Date.now();
